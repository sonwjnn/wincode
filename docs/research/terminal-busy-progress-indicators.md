...
The chat footer renders the progress component only while busy and follows it with an agent-colored `Esc` plus a muted interrupt hint ([source](../../wincode-cli/src/modules/sessions/ui/components/chat-shell.tsx#L156-L166)). This textual hint preserves meaning independently of color or motion.
