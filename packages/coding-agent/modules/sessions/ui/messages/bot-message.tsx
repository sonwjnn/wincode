...
import { type CodingToolRecovery, isCodingToolRecovery } from "@/modules/tools";
import {
	boundCommandHeader,
	boundPreview,
	computeContentWidth,
...
/**
 * The themed session block for a completed `shell` call: the bounded
...
export function BotMessageFooter({ message }: { message: SessionMessage }) {
	const { colors } = useTheme();
