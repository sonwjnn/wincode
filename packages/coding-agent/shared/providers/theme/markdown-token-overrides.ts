...
/**
 * Per-theme markdown and syntax token palettes, sourced from matching OpenCode
 * theme assets, so each Wincode theme keeps the markdown identity OpenCode tuned
 * for it.
