...
type FilePart = Extract<SessionMessage["parts"][number], { type: "file" }>;
...
const isTextPart = (part: SessionMessage["parts"][number]): part is TextPart =>
	part.type === "text";

const isImagePart = (part: SessionMessage["parts"][number]): part is FilePart =>
...
export const getAppliedSkill = (
	...
	if (!isObjectLike(metadata.skill)) {
		return;
	}
