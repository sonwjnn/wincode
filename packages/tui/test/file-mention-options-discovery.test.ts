...
describe("file mention option discovery", () => {
	test("discovers deeply nested entries and skips ignored directories", async () => {
		...
		const deepDirectory = "packages/tui/src/modules/sessions/ui/messages";
		...
		expect(options).toContainEqual({
			label: "packages/tui/src/modules/sessions/ui/messages/",
			path: "packages/tui/src/modules/sessions/ui/messages",
			type: "directory",
		});
	});
